...
const firebaseConfig = {
  ...
  const contactInfoRef = ref(db, "GeneralEnquiryContactInfo");

function saveContactFormData(Fname, Email, Phone, State, City, PinCode, selectedValue, InquiryType, Message) {
